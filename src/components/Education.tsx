                  ...
                  {item.link && (
                    <div className="text-center">
                      <a
                        ...
                        className="inline-flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg font-medium hover:shadow-lg hover:opacity-90 transition-all duration-200 touch-target"
                      >
